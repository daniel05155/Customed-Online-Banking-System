...
class Transaction(models.Model):
    ...
    transaction_balance_after = models.DecimalField(max_digits=15, decimal_places=2, default=0)
...
class Transfer(models.Model):
    ...
    # transfer_time = models.DateTimeField(auto_now_add=True)                         # Ref: Transaction.transaction_time
